...
import { HeaderTwoComponent } from './Admin/controlPanal/shared/Admin-header/admin-header.component';
import { FooterTwoComponent } from './Admin/controlPanal/shared/Admin-footer/admin-footer.component';
